...
class RmFileHandle {      
   ...
   public:
    RmFileHandle(DiskManager *disk_manager, BufferPoolManager *buffer_pool_manager, int fd,DiskScheduler *disk_scheduler = nullptr)
        ...
        disk_scheduler->read_page(fd, RM_FILE_HDR_PAGE, (char *)&file_hdr_, sizeof(file_hdr_));
